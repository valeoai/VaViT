...
|----------|---------------|:---------------------:|
| VaViT-B  | nuScenes      |  [81.3 % / 81.3 %](https://github.com/valeoai/VaViT/releases/download/v0.1.0/nuscenes.tgz)        |
| VaViT-B  | SemanticKITTI |  [67.6 % / 68.0 %](https://github.com/valeoai/VaViT/releases/download/v0.1.0/semantic_kitti.tgz)  |
| VaViT-B  | WOD           |  [70.5 % / 70.9 %](https://github.com/valeoai/VaViT/releases/download/v0.1.0/waymo.tgz)           |
